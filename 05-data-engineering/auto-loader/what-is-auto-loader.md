...
```mermaid
graph TD
    Q1{"디렉토리 내<br/>파일 수가<br/>얼마나 되나요?"}
    Q1 -->|"수만 개 이하"| DL["✅ Directory Listing<br/>(기본값, 간편)"]
    Q1 -->|"수십만~수백만 개"| FE["✅ File Events<br/>(GA, 권장)"]
    Q1 -->|"수백만 개 이상 +<br/>극한 성능 필요"| FN["✅ File Notification<br/>(클라우드 이벤트 사용)"]
```
