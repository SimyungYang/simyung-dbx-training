...
timeline
    ...
    2013 : Databricks 설립
    2014 : Apache Spark 1.0 출시
         : Apache Flink 탄생
    2015 : Spark 2.0 (DataFrame API)
    2016 : Delta Lake 개념 시작
    2017 : Snowflake 성장 가속
    2019 : Delta Lake 오픈소스화
    2020 : Lakehouse 논문 발표
    2021 : Unity Catalog 발표
    2023 : MLflow 2.0 (GenAI 지원)
    2024 : Spark 4.0, Liquid Clustering
    2025 : Agent Bricks, Lakebase GA
```
...
```mermaid
graph LR
    subgraph 2006["2006~2012"]
        A["Hadoop<br/>(분산 저장/처리)"]
    end
    subgraph 2014["2013~2018"]
        B["Spark + Cloud DW<br/>(2-Platform 시대)"]
    end
    subgraph 2020["2019~현재"]
        C["Lakehouse<br/>(통합 플랫폼)"]
    end
