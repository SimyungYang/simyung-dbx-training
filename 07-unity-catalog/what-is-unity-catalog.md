...
graph TD
    ...
    ACCOUNT --> MS["📦 Metastore<br/>(리전별 1개)"]

    MS --> WS1["💻 Workspace 1"]
    MS --> WS2["💻 Workspace 2"]
    MS --> WS3["💻 Workspace 3"]

    MS --> CAT1["📁 Catalog: production"]
    MS --> CAT2["📁 Catalog: development"]
    MS --> CAT3["📁 Catalog: staging"]

    CAT1 --> SCH1["📂 Schema: ecommerce"]
    CAT1 --> SCH2["📂 Schema: finance"]

    SCH1 --> TBL["📊 Table: orders"]
    SCH1 --> VIEW["👁️ View: daily_summary"]
    SCH1 --> VOL["📁 Volume: raw_files"]
    SCH1 --> FUNC["⚡ Function: calc_tax"]
    SCH1 --> MODEL["🤖 Model: fraud_detector"]
```
