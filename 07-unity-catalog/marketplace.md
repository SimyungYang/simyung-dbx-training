...
```
[데이터 플랫폼팀]                    [프라이빗 Marketplace]
    │                                      │
    ├── Gold 고객 360 테이블 ──────→ 리스팅: "Customer 360"
    ├── Gold 매출 분석 테이블 ──────→ 리스팅: "Sales Analytics"
    ├── ML 고객 이탈 예측 모델 ────→ 리스팅: "Churn Prediction Model"
    └── 분석 노트북 모음 ─────────→ 리스팅: "Analytics Starter Kit"
                                           │
                                    ┌──────┼──────┐
                                    ▼      ▼      ▼
                                 마케팅팀  영업팀  경영진
