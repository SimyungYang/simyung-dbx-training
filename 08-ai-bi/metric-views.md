# Metric Views — 거버넌스가 적용된 비즈니스 메트릭

## Metric View란?

> 💡 **Metric View(메트릭 뷰)**는 비즈니스 메트릭을 **중앙에서 한 번 정의하고, 어디서든 일관되게 사용**할 수 있도록 하는 Unity Catalog의 기능입니다. "매출"이라는 지표가 팀마다 다르게 계산되는 문제를 근본적으로 해결합니다.
